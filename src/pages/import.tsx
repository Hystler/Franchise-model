    ...
    <Shell>
      <div className="pageHeader">
        <div>
          ...
          <p>Загрузите меню, ингредиенты и рецептуры. CAPEX, OPEX и налоги лучше заполнять вручную в соответствующих разделах, чтобы допущения оставались прозрачными.</p>
        </div>
      </div>
