...
export default async function handler(_req: NextApiRequest, res: NextApiResponse) {
  ...
  const inputUnits = [
    ...
    { field: "supplyChainMarkup", unit: "%", note: "наценка к себестоимости" },
    { field: "openingInventory", unit: "₽", note: "часть инвестиций на открытие" },
    { field: "launchMarketing", unit: "₽", note: "часть инвестиций на открытие" },
    { field: "rentDeposit", unit: "₽", note: "часть инвестиций на открытие" },
